...
class _KhaltiSDKDemoState extends State<KhaltiSDKDemo> {
  ...
  String pidx = 'fCgiQG9dPtm4iQdAi23Aaj'; // Should be generated via a server-side POST request.
  ...
  void initState() {
    ...
    final payConfig = KhaltiPayConfig(
      publicKey: '3ff578acbc104826a4ffd11b989a079f', // This is a dummy public key for example purposes
      pidx: pidx,
